...
function thold_config_settings () {
	...
	$settings['alerts'] = array(
        ...
        'thold_sms_provider' => array(
            ...
            'method' => 'drop_array',
            'default' => 1,
            'array' => array(1 => 'Nexmo', 2 => 'SMSGlobal'),
            ),
        'thold_sms_api_key' => array(
            'friendly_name' => 'API Key / Username',
            'description' => 'Provider API Key or Username.',
            'method' => 'textbox',
            'size' => 80,
            'max_length' => 255,
            ),
        'thold_sms_api_secret' => array(
            'friendly_name' => 'API Secret / Password ',
            'description' => 'Provider API Key Secret or Password.',
            'method' => 'textbox',
            'size' => 80,
            'max_length' => 255,
            ),
